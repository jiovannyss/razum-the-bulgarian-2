...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-2 z-[9999] bg-section-background backdrop-blur-lg border-b border-purple-700/50 rounded-t-2xl border border-purple-700 border-b-0">
